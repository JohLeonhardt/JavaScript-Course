...
// SO if you have two strings and there is a (+) between them then it creates a string and add them next to each other

// if the strings with a (+) between them are numbers only then they will be added

// if you have two strings with a minus (-) between them then you get NaN
